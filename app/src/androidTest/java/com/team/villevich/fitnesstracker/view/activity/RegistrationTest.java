                ...
                allOf(withId(R.id.email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView.perform(scrollTo(), replaceText("vlad-i@ukr.net"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.reg_email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView2.perform(scrollTo(), replaceText("vlad"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.reg_weight),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView3.perform(scrollTo(), replaceText("32"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.reg_height),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView4.perform(scrollTo(), replaceText("321"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.reg_age),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView5.perform(scrollTo(), replaceText("54"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.reg_daily_calories),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView6.perform(scrollTo(), replaceText("3214"), closeSoftKeyboard());
